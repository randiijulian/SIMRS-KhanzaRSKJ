 ...
 * @author perpustakaan
 */
public final class DlgRujukBerkelanjutan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRujukBerkelanjutan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MnSuratRujukBerkelanjutan = new javax.swing.JMenuItem();
        ...
        MnSuratRujukBerkelanjutan.setBackground(new java.awt.Color(255, 255, 254));
        MnSuratRujukBerkelanjutan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSuratRujukBerkelanjutan.setForeground(new java.awt.Color(50, 50, 50));
        MnSuratRujukBerkelanjutan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnSuratRujukBerkelanjutan.setText("Surat Rujuk Berkelanjutan");
        MnSuratRujukBerkelanjutan.setName("MnSuratRujukBerkelanjutan");
        MnSuratRujukBerkelanjutan.setPreferredSize(new java.awt.Dimension(250, 26));
        MnSuratRujukBerkelanjutan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSuratRujukBerkelanjutanActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnSuratRujukBerkelanjutan);

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setUndecorated(true);
        setResizable(false);

        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Rujuk Berkelanjutan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-04-2025" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRj.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("rujuk_berkelanjutan","'"+TNoRj.getText()+"','"+TNoRw.getText()+"','"+Valid.SetTgl(DTPRujuk.getSelectedItem()+"")+"',"+
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,TNoRj,"rujuk_berkelanjutan","no_rujuk")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRj.getText().trim().equals("")){
            ...
            if(Valid.editTabletf(tabMode,"rujuk_berkelanjutan","no_rujuk",TNoRj,"no_rawat='"+TNoRw.getText()+"',tgl_rujuk='"+Valid.SetTgl(DTPRujuk.getSelectedItem()+"")+"',"+
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            String tgl=" rujuk_berkelanjutan.tgl_rujuk between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            Valid.MyReportqry("rptRujukBerkelanjutan.jasper","report","::[ Data Rujuk Berkelanjutan Pasien ]::","select rujuk_berkelanjutan.no_rujuk,rujuk_berkelanjutan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                "rujuk_berkelanjutan.tgl_rujuk,rujuk_berkelanjutan.jam,rujuk_berkelanjutan.keterangan_diagnosa,rujuk_berkelanjutan.kd_dokter,dokter.nm_dokter,rujuk_berkelanjutan.kat_rujuk,rujuk_berkelanjutan.keterangan,"+
                "rujuk_berkelanjutan.edukasi1,rujuk_berkelanjutan.edukasi2,rujuk_berkelanjutan.edukasi3 "+
                "rujuk_berkelanjutan.edukasi_lanjut1,rujuk_berkelanjutan.edukasi_lanjut2,rujuk_berkelanjutan.edukasi_lanjut3 "+
                "from rujuk_berkelanjutan inner join reg_periksa inner join pasien inner join dokter "+
                "on rujuk_berkelanjutan.no_rawat=reg_periksa.no_rawat "+
                "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "and rujuk_berkelanjutan.kd_dokter=dokter.kd_dokter "+
                "where "+tgl+"and no_rujuk like '%"+TCari.getText().trim()+"%' or "+
                tgl+"and rujuk_berkelanjutan.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                tgl+"and rujuk_berkelanjutan.tgl_rujuk like '%"+TCari.getText().trim()+"%' or "+
                tgl+"and rujuk_berkelanjutan.keterangan_diagnosa like '%"+TCari.getText().trim()+"%' or "+
                tgl+"and rujuk_berkelanjutan.kd_dokter like '%"+TCari.getText().trim()+"%' or "+
                tgl+"and dokter.nm_dokter like '%"+TCari.getText().trim()+"%' "+
                " order by rujuk_berkelanjutan.no_rujuk",param);
            
//                "FROM rujuk_berkelanjutan " +
//                "INNER JOIN reg_periksa ON rujuk_berkelanjutan.no_rawat = reg_periksa.no_rawat " +
//                "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis " +
//                "INNER JOIN dokter ON rujuk_berkelanjutan.kd_dokter = dokter.kd_dokter " +
//                "WHERE " + tgl + " AND (" +
//                    "no_rujuk LIKE '%" + TCari.getText().trim() + "%' OR " +
//                    "rujuk_berkelanjutan.no_rawat LIKE '%" + TCari.getText().trim() + "%' OR " +
//                    "reg_periksa.no_rkm_medis LIKE '%" + TCari.getText().trim() + "%' OR " +
//                    "pasien.nm_pasien LIKE '%" + TCari.getText().trim() + "%' OR " +
//                    "rujuk_berkelanjutan.rujuk_ke LIKE '%" + TCari.getText().trim() + "%' OR " +
//                    "rujuk_berkelanjutan.tgl_rujuk LIKE '%" + TCari.getText().trim() + "%' OR " +
//                    "rujuk_berkelanjutan.keterangan_diagnosa LIKE '%" + TCari.getText().trim() + "%' OR " +
//                    "rujuk_berkelanjutan.kd_dokter LIKE '%" + TCari.getText().trim() + "%' OR " +
...
private void TDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TDokterKeyPressed
    ...
    private void MnSuratRujukBerkelanjutanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratRujukBerkelanjutanActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            param.put("emailrs",akses.getemailrs());
            param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
            Valid.MyReportqry("rptRujukBerkelanjutan.jasper","report","::[ Surat Rujuk Berkelanjutan ]::",
                "select rujuk_berkelanjutan.no_rujuk,reg_periksa.no_rawat,pasien.alamat,pasien.no_tlp,dokter.nm_dokter, "+
                "rujuk_berkelanjutan.edukasi1,rujuk_berkelanjutan.edukasi2,rujuk_berkelanjutan.edukasi3, "+
                "rujuk_berkelanjutan.edukasi_lanjut1,rujuk_berkelanjutan.edukasi_lanjut2,rujuk_berkelanjutan.edukasi_lanjut3, "+
                "reg_periksa.no_rkm_medis,pasien.jk,pasien.keluarga,pasien.namakeluarga,pasien.tgl_lahir,pasien.nm_pasien,"+
                "reg_periksa.almt_pj,pasien.umur,reg_periksa.tgl_registrasi,rujuk_berkelanjutan.tgl_rujuk from reg_periksa "+
                "inner join pasien inner join rujuk_berkelanjutan inner join dokter  on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "and reg_periksa.no_rawat=rujuk_berkelanjutan.no_rawat and rujuk_berkelanjutan.kd_dokter=dokter.kd_dokter where reg_periksa.no_rawat='"+TNoRw.getText()+"'",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_MnSuratRujukBerkelanjutanActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRujukBerkelanjutan dialog = new DlgRujukBerkelanjutan(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem MnSuratRujukBerkelanjutan;
    ...
    public void tampil() {
        ...
        try{
            tgl=" rujuk_berkelanjutan.tgl_rujuk between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
            sql="select rujuk_berkelanjutan.no_rujuk,rujuk_berkelanjutan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                "rujuk_berkelanjutan.tgl_rujuk,rujuk_berkelanjutan.jam,rujuk_berkelanjutan.keterangan_diagnosa,rujuk_berkelanjutan.kd_dokter,dokter.nm_dokter,rujuk_berkelanjutan.kat_rujuk,rujuk_berkelanjutan.keterangan,"+
                "rujuk_berkelanjutan.edukasi1,rujuk_berkelanjutan.edukasi2,rujuk_berkelanjutan.edukasi3, "+
                "rujuk_berkelanjutan.edukasi_lanjut1,rujuk_berkelanjutan.edukasi_lanjut2,rujuk_berkelanjutan.edukasi_lanjut3 "+
                "from rujuk_berkelanjutan inner join reg_periksa inner join pasien inner join dokter "+
                ...
                "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "and rujuk_berkelanjutan.kd_dokter=dokter.kd_dokter "+
                "where "+tgl+" and (no_rujuk like '%"+TCari.getText().trim()+"%' or rujuk_berkelanjutan.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                "reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                "rujuk_berkelanjutan.keterangan_diagnosa like '%"+TCari.getText().trim()+"%' or "+
                "rujuk_berkelanjutan.kd_dokter like '%"+TCari.getText().trim()+"%' or dokter.nm_dokter like '%"+TCari.getText().trim()+"%') "+
                " order by rujuk_berkelanjutan.no_rujuk";
...
//                "ORDER BY rujuk_berkelanjutan.no_rujuk";
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getrujukan_berkelanjutan());
        BtnHapus.setEnabled(akses.getrujukan_berkelanjutan());
        BtnPrint.setEnabled(akses.getrujukan_berkelanjutan());
    }
